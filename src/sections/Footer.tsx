    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <a href="https://www.instagram.com/yournextuniversity/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ opacity: 0.9 }}>
            <img
          ...
          <a href="https://x.com/YourNextUni" target="_blank" rel="noopener noreferrer" aria-label="X" style={{ opacity: 0.9 }}>
            <img
              src="https://pub-e63ee2f49d7e4f94b98011a5350eea0f.r2.dev/twitter-svgrepo-com.svg"
              alt="X"
              width={28}
              height={28}
              style={{ borderRadius: '7px', background: '#fff', boxShadow: '0 2px 8px #9F7AEA22' }}
